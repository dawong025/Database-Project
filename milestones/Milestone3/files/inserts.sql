...
INSERT INTO Loans(loan_id, type, interest_type, bank_id, bank_account_id, terms_conditions)
VALUES
(1, "Personal", "Flat", 1, 1, "BORROWER will make payment to LENDER in one payment of $100"),
(2, "Business", "Fixed", 2, 2, "As collateral for repayment of Loan Amount, BORROWER agrees to put forth a total of 10 Tesla (TSLA) shares"),
(3, "Mortgage", "Variable", 3, 3, "The Borrower has the right to pay back the loan in-full or make additional
payments, at any time, without penalty");

INSERT INTO Devices (device_id, manufacturer_id, type, status, atm_machine_id, made)
VALUES
(1, 1, "Screen", "Working", 1, now()),
(2, 2, "Sound", "Working", 1, now()),
(3, 3, "Scanner", "Not working", 1, now()),
(4, 3, "I/O", "Working", 1, now());
...
INSERT Logins (login_id, verified_user_id, data, logged_in, atm_machine_id)
VALUES
...
INSERT INTO Verifies(verifies_id, keypad_id, NFC_scanner_id, card_reader_id, bank_account_id, verified_at)
VALUES
(1, 1, 1, 1, 1, now()),
(2, 2, 2, 2, 2, now()),
(3, 3, 3, 3, 3, now());
...
INSERT INTO Scans(scans_id, card_id, card_reader_id, nfc_scanner_id, scanned)
VALUES
(1, 1, 1, 1, now()),
(2, 2, 2, 2, now()),
(3, 3, 3, 3, now());
